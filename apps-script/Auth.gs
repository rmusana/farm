...
var Auth = {
  ...
  bootstrapUsers: function () {
    return [
      { UserID: 'usr_robert', Email: 'robert@luk54.com', Name: 'Robert Musana', Role: 'Investor', PasswordHash: 'REMOVED', Active: true, GoogleSub: '', LastLogin: '' },
      { UserID: 'usr_moses', Email: 'moses@luk54.com', Name: 'Moses Odong', Role: 'Investor', PasswordHash: 'REMOVED', Active: true, GoogleSub: '', LastLogin: '' },
      { UserID: 'usr_joseph', Email: 'joseph@jalodreamfarm.com', Name: 'Jalo Dream Farm', Role: 'OperationsManager', PasswordHash: 'REMOVED', Active: true, GoogleSub: '', LastLogin: '' },
      { UserID: 'usr_admin', Email: 'admin@rmusana.com', Name: 'System Admin', Role: 'Administrator', PasswordHash: 'REMOVED', Active: true, GoogleSub: '', LastLogin: '' }
    ];
  },
